...
namespace Post.Query.Api.Controllers
{
    ...
    public class PostLookupController : ControllerBase
    {
        ...
        public async Task<ActionResult> GetAllPostsAsync()
        {
            ...
            {
                const string SAFE_ERROR_MESSAGE = "Erro while processing request to retrieve all posts!";
        ...
        public async Task<ActionResult> GetPostByIdAsync(Guid postId)
        {
            ...
            {
                const string SAFE_ERROR_MESSAGE = "Erro while processing request to post by ID!";
        ...
        public async Task<ActionResult> GetPostsByAuthorAsync(string author)
        {
            ...
            {
                const string SAFE_ERROR_MESSAGE = "Erro while processing request to find posts by author!";
        ...
        public async Task<ActionResult> GetPostsWithCommentsAsync()
        {
            ...
            {
                const string SAFE_ERROR_MESSAGE = "Erro while processing request to find posts with comments!";
        ...
        public async Task<ActionResult> GetPostsWithLikesAsync(int numberOfLikes)
        {
            ...
            {
                const string SAFE_ERROR_MESSAGE = "Erro while processing request to find posts with likes!";
